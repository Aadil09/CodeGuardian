...
// ⚡ IMPORTANT: cache connections (avoid reconnect every request)
let isInitialized = false;

async function init() {
  if (!isInitialized) {
    await connectDatabase();
    // Only init queue if Redis is configured (not available on Vercel serverless)
...
module.exports = async (req, res) => {
  await init(); // ensure DB + queue init
